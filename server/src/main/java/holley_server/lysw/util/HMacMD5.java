...
public class HMacMD5 {
    ...
    private final static Logger logger = Logger.getLogger(HMacMD5.class);
    ...
    public static String getHmacMd5Str(String key, String data) {
        ...
        try {
            ...
            for (int i = 0; i < hmacMd5Byte.length; i++) {
                if (Integer.toHexString(0xFF & hmacMd5Byte[i]).length() == 1) md5StrBuff.append("0").append(Integer.toHexString(0xFF & hmacMd5Byte[i]));
    ...
    public static void main(String[] args) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        System.out.println("16D2009C6811111111111168FEFEFEFEFE".length());
    }
}
